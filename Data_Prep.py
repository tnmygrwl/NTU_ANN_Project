...
with open('/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/DJIA indices data.csv', 'rb') as csvfile:
...
for year in years:
    for month in months:
        file_str = '/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/nytimes/' + str(year) + '-' + '{:02}'.format(month) + '.json'
...
#filtered_data.to_pickle('/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/Pickled ten year filtered data (Articles + DJIA).pkl')  


# Saving the data as pickle file
interpolated_df.to_pickle('/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/Pickled ten year filtered data (Articles + DJIA).pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/Pickled ten year filtered data (Articles + DJIA).pkl',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('/Users/christina/Desktop/ntuProject/Stock_Market_Prediction/Data/Pickled ten year filtered data (Articles + DJIA).pkl')
